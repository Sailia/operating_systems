...
public class H_ThreadJoin {
	...
	public static void main(String[] args) {
		...
		/*
			We can prevent the execution of a thread by using one of the following methods:
				yield(), sleep() and join() methods
		*/
		
		/*
		join(): is used to join the start of a thread�s execution to end of other thread�s execution 
