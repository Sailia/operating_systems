...
public class Question1_WithdrawDeposit {
	...
	// add below any further resources you think the deposit and withdraw functions must share
	...
	public static void Deposit(int amount){
	    try {
	   		...
	   		System.out.println("Problem with the deposit function "+e.toString());
	   	}
	}
